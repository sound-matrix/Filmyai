...
export function SpotlightBanner() {
  return (
    <section className="relative mb-8 overflow-hidden rounded-xl bg-filmy-card">
      <div className="flex aspect-[16/9] w-full flex-col justify-end bg-gradient-to-t from-black via-zinc-900/80 to-zinc-800 sm:aspect-[21/9]">
        ...
        <div className="relative z-10 space-y-3 p-4 sm:p-8">
          ...
          <h1 className="text-2xl font-bold sm:text-3xl md:text-4xl">Title placeholder</h1>
          ...
          <div className="flex flex-wrap gap-3 pt-1">
            ...
            <Link
              href={`#browse`}
              className="inline-flex min-h-11 items-center rounded-md border border-zinc-600 bg-zinc-900/60 px-5 py-2.5 text-sm font-medium text-filmy-muted transition hover:border-zinc-400 hover:text-white"
            >
              Browse
            </Link>
          </div>
